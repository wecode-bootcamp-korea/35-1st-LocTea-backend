    ...
    def get(self, request, product_id):
        try:
            ...
            result = {
                ...
                'first_category'  : {
                    'id'   : product.second_category.first_category.id,
                    'title': product.second_category.first_category.title
                    },
                'second_category' : {
                    'id'   : product.second_category.id,
                    'title': product.second_category.title
                    },
                'price'           : product.price,
                'stock'           : product.stock,
